...
* Two things to note while defining variables
	1. When referring to or reading a variable we place a $ sign before the variable name.
	2. When setting a variable we leave out the $ sign.
...
* The variables can only store a single word. To store complex values use single or double quotes.
